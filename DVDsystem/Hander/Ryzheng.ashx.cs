...
namespace DVDsystem.Hander
{
    ...
    /// yzheng2 的摘要说明
    /// </summary>
    public class Ryzheng : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session["Rcheck"] = str.ToString(); //这一步是为了将验证码写入Session，进行验证，不能缺省，也可一使用cookie
        ...
        //生成图像
        private void getImageValidate(string strValue, HttpContext context)
        {
